...
module Primero
  class Application < Rails::Application
    ...
    LOCALE_ARABIC = 'ar'
    LOCALE_SPANISH = 'es'
    LOCALE_SPANISH_GUATELAMA = 'es_GT'
    ...
    LOCALES = [LOCALE_ENGLISH, LOCALE_FRENCH, LOCALE_ARABIC, LOCALE_LEBANON, LOCALE_SOMALI, LOCALE_SPANISH, LOCALE_BANGLA,
               LOCALE_INDONESIAN, LOCALE_BURMESE, LOCALE_THAI, LOCALE_KURDISH, LOCALE_PORTUGUESE, LOCALE_JORDAN, LOCALE_KHMER,
               LOCALE_SPANISH_GUATELAMA]
    LOCALES_WITH_DESCRIPTION = [
      ...
      ['Español (Guatemala)', LOCALE_SPANISH_GUATELAMA],
