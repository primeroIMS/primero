  ...
  module Model
    module Typecast
      ...
      def typecast_value(parent, property, value)
        ...
        elsif [String, Symbol, TrueClass, Integer, Float, BigDecimal, DateTime, Time, Date, PrimeroDate, Class].include?(type)
      ...
      protected
        ...
        # Typecasts an arbitrary value to a Date using PrimeroDate.parse
        def typecast_to_primerodate(value)
          if value.is_a?(Hash)
