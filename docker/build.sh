...
BUILD_APP="docker build  --no-cache -f application/Dockerfile ../ -t application:prim-latest --build-arg APP_ROOT=${APP_ROOT} --build-arg RAILS_LOG_PATH=${RAILS_LOG_PATH}"
