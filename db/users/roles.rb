...
gbv_mobile_caseworker_permissions = [
  ...
  Permission.new(
    resource: Permission::DASHBOARD,
    actions: [Permission::DASH_CASE_INCIDENT_OVERVIEW]
  )
]
...
gbv_agency_user_admin_permissions = [
  Permission.new(
    resource: Permission::ROLE,
    actions: [Permission::READ, Permission::ASSIGN],
    role_unique_ids: ['role-gbv-case-management-supervisor', 'role-gbv-caseworker', 'role-gbv-manager',
...
gbv_system_admin_permissions = [
  ...
  Permission.new(
    ...
    role_unique_ids: ['role-gbv-manager', 'role-gbv-social-worker', 'role-gbv-user-manager']
  ),
  Permission.new(
    resource: Permission::USER,
    actions: [
