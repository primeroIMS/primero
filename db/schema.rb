...
ActiveRecord::Schema.define(version: 2021_04_25_000000) do
  ...
  create_table "agencies", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", default: "2021-05-17 16:45:26", null: false
    t.datetime "updated_at", default: "2021-05-17 16:45:26", null: false
