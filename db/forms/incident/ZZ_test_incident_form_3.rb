zz_test_incident_fields = [
  Field.new({"name" => "zz_test_incident_report_submitted",
             "type" => "select_box",
  ...
  Field.new({"name" => "zz_test_incident_date_submitted",
             "type" => "date_field",
             "display_name_all" => "Date of submission"
            }),
  Field.new({"name" => "zz_test_incident_recommendation",
             "type" => "select_box",
  ...
  Field.new({"name" => "zz_test_incident_recommendation_date",
             "type" => "date_field",
             "display_name_all" => "Date of Recommendation"
            }),
  Field.new({"name" => "zz_test_incident_proposed_support",
             "type" => "text_field",
             "display_name_all" => "Proposed Support"
            }),
  Field.new({"name" => "zz_test_incident_agency_responsible",
             "type" => "text_field",
             "display_name_all" => "Agency Responsible"
            }),
  Field.new({"name" => "zz_test_incident_proposed_support_accepted",
             "type" => "select_box",
             "display_name_all" => "Does the child accept the proposed support?",
             "option_strings_text_all" => "Yes\nNo",
           }),
  Field.new({"name" => "zz_test_incident_why_support_refused",
             "type" => "text_field",
             "display_name_all" => "If refused, why?"
            }),
  Field.new({"name" => "zz_test_incident_date_implementation",
             "type" => "date_field",
             "display_name_all" => "Date of Implementation"
            }),
  Field.new({"name" => "zz_test_incident_implementing_agency",
             "type" => "text_field",
