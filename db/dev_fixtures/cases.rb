...

{
  'ff928802-455b-4735-9e5c-4ed9acace001' => lambda do |c|
    ...
    c.date_of_birth = Date.new(2005, 0o1, 0o1)
    c.sex = 'Male'
    c.address_is_permanent = true
    c.address_current = '1 Arid Way'
    c.protection_concerns = %w[Migrant Disabled]
  end,
  ...
  'ef928802-455b-4735-9e5c-4ed9acace002' => lambda do |c|
    ...
    c.protection_concerns = %w[Migrant Disabled Refugee]
  end,

  'df928802-455b-4735-9e5c-4ed9acace003' => lambda do |c|
  ...
  'df928802-455b-4735-9e5c-4ed9acace005' => lambda do |c|
    ...
    c.consent_info_sharing = %w[Family UNHCR]
  end,
