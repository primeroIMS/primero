...
create_or_update_lookup(
  ...
  :lookup_values => [
    ...
    {id: "congo,_republic_of_the", display_text: "Congo, Republic of the"}.with_indifferent_access,
    {id: "congo,_democratic_republic_of_the", display_text: "Congo, Democratic Republic of the"}.with_indifferent_access,
    {id: "costa_rica", display_text: "Costa Rica"}.with_indifferent_access,
    {id: "cote_d'ivoire", display_text: "Cote d'Ivoire"}.with_indifferent_access,
    ...
    {id: "guinea-bissau", display_text: "Guinea-Bissau"}.with_indifferent_access,
    ...
    {id: "myanmar_burma", display_text: "Myanmar (Burma)"}.with_indifferent_access,
    ...
    {id: "st._kitts_and_nevis", display_text: "St. Kitts and Nevis"}.with_indifferent_access,
    {id: "st._lucia", display_text: "St. Lucia"}.with_indifferent_access,
    {id: "st._vincent_and_the_grenadines", display_text: "St. Vincent and The Grenadines"}.with_indifferent_access,
    ...
    {id: "timor-leste", display_text: "Timor-Leste"}.with_indifferent_access,
    ...
    {id: "uk_united_kingdom", display_text: "UK (United Kingdom)"}.with_indifferent_access,
    {id: "usa_united_states_of_america", display_text: "USA (United States of America)"}.with_indifferent_access,
    ...
    {id: "vatican_city_holy_see", display_text: "Vatican City (Holy See)"}.with_indifferent_access,
