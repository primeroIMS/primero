...
describe "form_section/_select_box.html.erb" do
  ...
  it "should include image for tooltip when help text exists" do
    ...
    expect(rendered).to match(/<select class="chosen-select " data-field-tags="\[\]" data-placeholder="\(Select...\)" data-populate="null" data-value="" id="formsection_child_new_field" is_disabled="false" name="child\[new field\]">/)
