...
describe "form_section/_radio_button.html.erb" do
  ...
  it "should display radio button" do
    ...
    expect(rendered).to match(/<input data-field-tags="\[\]" id="formsection_child_new_field" is_disabled="false" name="child\[new field\]" type="radio" value="male_test" \/>/)
    expect(rendered).to match(/<label for="formsection_child_new_field_male_test">Male Test<\/label>/)
    expect(rendered).to match(/<input data-field-tags="\[\]" id="formsection_child_new_field" is_disabled="false" name="child\[new field\]" type="radio" value="female_test" \/>/)
