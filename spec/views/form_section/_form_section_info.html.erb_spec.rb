...
describe "form_section/_form_section_info.html.erb" do
    ...
    it "should show neither" do
      ...
      render :partial => 'form_section/form_section_info', :locals => { :form_section => form_section }, :formats => [:html], :handlers => [:erb]
