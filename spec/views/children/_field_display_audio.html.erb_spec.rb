...
describe "children/_field_display_audio.html.erb" do
  ...
  it "should show the delete audio checkbox" do
    ...
    render :partial => 'children/field_display_audio', :locals => { :field => nil, :child => child, :display_audio_delete_checkbox => true}, :formats => [:html], :handlers => [:erb]
  ...
  it "should not show the delete audio checkbox" do
    ...
    render :partial => 'children/field_display_audio', :locals => { :field => nil, :child => child, :display_audio_delete_checkbox => false}, :formats => [:html], :handlers => [:erb]
    rendered.should have_tag(".profile-section-label")
    rendered.should have_tag("a#audio_link")
