  ...
  #describe "when generating a CSV download" do
    #describe "with just a name field" do
      ...
      #it 'should render a row for each result, plus a header row' do
        #FormSection.stub(:all_visible_form_fields).and_return [Field.new_text_field("name")]
        #csv_data = CSV.parse subject.data
      ...
      #it 'should have a photo column with appropriate links' do
        #FormSection.stub(:all_visible_form_fields).and_return [Field.new_text_field('_id'), Field.new_text_field("name"), Field.new_text_field("current_photo_key")]
        #csv_data = CSV.parse subject.data
      ...
      #it 'should have an audio column with appropriate links' do
        #FormSection.stub(:all_visible_form_fields).and_return [Field.new_text_field('_id'), Field.new_text_field("name"), Field.new_text_field("some_audio")]
        #csv_data = CSV.parse subject.data
    ...
    #describe "with a multi checkbox field" do
      #subject do
        #FormSection.stub(:all_visible_form_fields).and_return [Field.new_check_boxes_field("multi")]
        #ExportGenerator.new( [
