...
describe AdvancedSearchController do
  ...
  describe 'collection' do
    xit "GET export_data" do
      ...
      get :export_data, params: {:commit => "Export Selected to PDF"}
  ...
  context 'search' do
    ...
    xit "should perform a search using the parameters passed to it for admin users" do
      ...
      get :index, params: {:page => 2, :criteria_list => {"0" => {"field" => "name_of_child", "value" => "joe joe", "index" => "0"}}, :created_by_value => nil}
    ...
    xit "should append created_by as self for limited users" do
      ...
      get :index, params: {:criteria_list => {"0" => {"field" => "name_of_child", "value" => "joe joe", "index" => "0"}}, :created_by_value => nil}
    ...
    context 'search filters' do
      ...
      xit "should append search filter 'created_by' to the list of search criteria for admin" do
        ...
        get :index, params: {:criteria_list => {"0" => {"field" => "name_of_child", "value" => "joe joe", "index" => "0"}}, :created_by_value => "johnny_user"}
      ...
      xit "should append search filter 'updated_by' to the list of search criteria" do
        ...
        get :index, params: {:criteria_list => {"0" => {"field" => "name_of_child", "value" => "joe joe", "index" => "0"}}, :updated_by_value => "johnny_user"}
      ...
      xit "should append search range 'created_at' to the list of search criteria" do
        ...
        get :index, params: {:criteria_list => {"0" => {"field" => "name_of_child", "value" => "joe joe", "index" => "0"}}, :created_at_after_value => "2012-04-23", :created_at_before_value => "2012-04-25"}
      ...
      xit "should append search range 'updated_at' to the list of search criteria" do
        ...
        get :index, params: {:criteria_list => {"0" => {"field" => "name_of_child", "value" => "joe joe", "index" => "0"}}, :updated_at_after_value => "2012-04-23", :updated_at_before_value => "2012-04-25"}
      ...
      xit "should append search filter 'created_by_organization' to the list of search criteria for admin" do
        ...
        get :index, params: {:criteria_list => {"0" => {"field" => "name_of_child", "value" => "joe joe", "index" => "0"}}, :created_by_organization_value => "STC"}
  ...
  describe "export data" do
    ...
    xit "should handle full PDF" do
      ...
      post :export_data, params: { :selections => { '0' => @child1.id, '1' => @child2.id }, :commit => "Export Selected to PDF" }
    end
    ...
    xit "should handle Photowall PDF" do
      ...
      post :export_data, params: { :selections => { '0' => @child1.id, '1' => @child2.id }, :commit => "Export Selected to Photo Wall" }
    end

    xit "should handle CSV" do
      Exporters::CSVExporter.should_receive(:export).with([ @child1, @child2 ], anything).and_return('data')
      post :export_data, params: { :selections => { '0' => @child1.id, '1' => @child2.id }, :commit => "Export Selected to CSV" }
    end
