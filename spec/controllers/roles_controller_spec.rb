...
describe RolesController do
  ...
  describe "GET edit" do
    ...
    it "should allow user to edit roles " do
      ...
      Role.should_receive(:find_by).with( {id: mock.id.to_s}).and_return(mock)
    ...
    it "should not allow user without permission to edit roles" do
      ...
      Role.stub :find_by => stub_model(Role)
  ...
  describe "POST update" do
    it "should allow valid user to update roles" do
      ...
      role_mock = {:name=>'', :description=>'', :transfer=>'false', :referral=>'false', :group_permission=>'', :form_sections=>'', :permissions=>[]}
  ...
  describe "POST create" do
    ...
    it "should take back to new page if save failed" do
      fake_login_as(Permission::ROLE, [Permission::READ, Permission::WRITE, Permission::CREATE])
      role_mock = {:name=>nil, :description=>nil, :transfer=>nil, :referral=>nil, :group_permission=>nil, :form_sections=>nil, :permissions=>[]}
  ...
  describe "DELETE" do
    it "should allow a valid user to delete a role" do
      ...
      Role.should_receive(:find_by).with({id: '100'}).and_return(role)
