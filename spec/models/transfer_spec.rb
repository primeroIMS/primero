...
describe Transfer do
  ...
  describe 'perform' do
    context 'in system' do
      xit 'allows the targeted user to have access to this record' do
      ...
      xit 'does not perform the transfer if the receiving user is not allowed to receive transfers' do
        permission_case = Permission.new(
          resource: Permission::CASE,
  ...
  describe 'accept' do
    xit 'changes the record owner' do
      transfer = Transfer.create(transitioned_by: 'user1', transitioned_to: 'user2', record: @case)
      transfer.accept!
  ...
  describe 'reject' do
    xit 'revokes access to this record for the target user' do
      transfer = Transfer.create(transitioned_by: 'user1', transitioned_to: 'user2', record: @case)
      transfer.reject!
