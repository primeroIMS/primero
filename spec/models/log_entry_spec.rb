...
describe LogEntry do
	...
	it "should save with creation timestamp" do
		...
		log_entry = LogEntry.create! :type => LogEntry::TYPE[:cpims], :username => "rapidftr", :organization => "urc", :export_format => "cpims", :number_or_records => "123"
	...
	it "should return all entries sorted by created_at date" do
		...
		old_entry = LogEntry.create! :type => LogEntry::TYPE[:csv], :username => "rapidftr", :organization => "urc", :export_format => "cpims", :number_or_records => "123"
		Clock.stub(:now).and_return(1.day.from_now)
		newest_entry = LogEntry.create! :type => LogEntry::TYPE[:cpims], :username => "rapidftr", :organization => "urc", :export_format => "cpims", :number_or_records => "123"
		Clock.stub(:now).and_return(2.days.ago)
		oldest_entry = LogEntry.create! :type => LogEntry::TYPE[:pdf], :username => "rapidftr", :organization => "urc", :export_format => "cpims", :number_or_records => "123"
