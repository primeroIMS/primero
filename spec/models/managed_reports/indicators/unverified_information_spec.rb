...
describe ManagedReports::Indicators::UnverifiedInformation do
  ...
  it 'return data for unverified information indicator' do
    ...
    expect(data).to match_array(
      [
        { group_id: 'boys', data: [{ id: 'denial_humanitarian_access', total: 1 }, { id: 'killing', total: 2 }] },
        { group_id: 'girls', data: [{ id: 'denial_humanitarian_access', total: 2 }, { id: 'killing', total: 0 }] },
        { group_id: 'unknown', data: [{ id: 'denial_humanitarian_access', total: 5 }, { id: 'killing', total: 2 }] },
        { group_id: 'total', data: [{ id: 'denial_humanitarian_access', total: 8 }, { id: 'killing', total: 4 }] }
      ]
    )
  end
end
