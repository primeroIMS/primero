      ...
      it 'should return results grouped by month' do
        ...
        expect(data).to match_array(
          [
            ...
            { group_id: 'may-2021', data: [{ id: 'E1', total: 2 }] },
            { group_id: 'february-2022', data: [{ id: 'E2', total: 4 }] },
      ...
      it 'should return results grouped by quarter' do
        ...
        expect(data).to match_array(
          [
            ...
            { group_id: 'q2-2021', data: [{ id: 'E1', total: 2 }] },
            { group_id: 'q1-2022', data: [{ id: 'E1', total: 5 }, { id: 'E2', total: 4 }] }
          ]
        )
      end
    end
