...
describe ManagedReports::Indicators::CaseWorkflowBySexAndAge do
  ...
  it 'returns data for case_workflow_by_sex_and_age indicator' do
    report_data = ManagedReports::Indicators::CaseWorkflowBySexAndAge.build(nil, {}).data
  ...
  describe 'records in scope' do
    it 'returns records for a self scope' do
      report_data = ManagedReports::Indicators::CaseWorkflowBySexAndAge.build(
        @self_user,
    ...
    it 'returns all records for an all scope' do
      report_data = ManagedReports::Indicators::CaseWorkflowBySexAndAge.build(@all_user, {}).data
