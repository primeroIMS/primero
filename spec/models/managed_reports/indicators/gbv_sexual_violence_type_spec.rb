  ...
  describe 'grouped by' do
    context 'when is year' do
      it 'should return results grouped by year' do
        ...
        expect(data).to match_array(
          [
            { 'data' => [{ 'id' => 'rape', 'total' => 2 }], 'group_id' => 2020 },
            {
              'data' => [
                { 'id' => 'physical_assault', 'total' => 1 },
                { 'id' => 'sexual_assault', 'total' => 1 }
            ...
            { 'data' => [{ 'id' => 'physical_assault', 'total' => 1 }], 'group_id' => 2022 }
          ]
        )
      end
    end
    ...
    context 'when is month' do
      it 'should return results grouped by month' do
        ...
        expect(data).to match_array(
          [
            { 'data' => [{ 'id' => 'rape', 'total' => 1 }], 'group_id' => 'august-2020' },
            { 'data' => [{ 'id' => 'rape', 'total' => 1 }], 'group_id' => 'september-2020' },
            {
              'data' => [
                { 'id' => 'physical_assault', 'total' => 1 },
                { 'id' => 'sexual_assault', 'total' => 1 }
            ...
            { 'data' => [{ 'id' => 'physical_assault', 'total' => 1 }], 'group_id' => 'october-2022' }
          ]
        )
      end
    end
    ...
    context 'when is quarter' do
      it 'should return results grouped by quarter' do
        ...
        expect(data).to match_array(
          [
            { 'data' => [{ 'id' => 'rape', 'total' => 2 }], 'group_id' => 'q3-2020' },
            {
              'data' => [
                { 'id' => 'physical_assault', 'total' => 1 },
                { 'id' => 'sexual_assault', 'total' => 1 }
            ...
            { 'data' => [{ 'id' => 'physical_assault', 'total' => 1 }], 'group_id' => 'q4-2022' }
          ]
        )
      end
    end
