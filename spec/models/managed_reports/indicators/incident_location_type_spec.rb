...
describe ManagedReports::Indicators::IncidentLocationType do
  before do
    ...
    Incident.new_with_user(
      @self_user,
      { incident_date: Date.new(2020, 8, 12), incident_location_type: 'forest' }
    ).save!
    Incident.new_with_user(
      @group_user,
    ...
    Incident.new_with_user(
      @all_user,
      { incident_date: Date.new(2020, 9, 12), incident_location_type: 'road' }
    ).save!
    Incident.new_with_user(
      @all_user,
  ...
  describe 'records in scope' do
    ...
    it 'returns group records for a group scope' do
      data = ManagedReports::Indicators::IncidentLocationType.build(@group_user).data
    ...
    it 'returns agency records for an agency scope' do
      data = ManagedReports::Indicators::IncidentLocationType.build(@agency_user).data
    ...
    it 'returns all records for an all scope' do
      data = ManagedReports::Indicators::IncidentLocationType.build(@all_user).data
