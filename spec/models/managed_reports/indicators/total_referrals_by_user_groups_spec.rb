...
describe ManagedReports::Indicators::TotalReferralsByUserGroups do
  ...
  it 'returns the total number of transfers by user group' do
    total_transfers = ManagedReports::Indicators::TotalReferralsByUserGroups.build.data
  ...
  describe 'records in scope' do
    it 'returns owned records for a self scope' do
      total_transfers = ManagedReports::Indicators::TotalReferralsByUserGroups.build(self_user).data
    ...
    it 'returns group records for a group scope' do
      total_transfers = ManagedReports::Indicators::TotalReferralsByUserGroups.build(group_user).data
    ...
    it 'returns agency records for an agency scope' do
      total_transfers = ManagedReports::Indicators::TotalReferralsByUserGroups.build(agency_user).data
    ...
    it 'returns all records for an all scope' do
      total_transfers = ManagedReports::Indicators::TotalReferralsByUserGroups.build(all_user).data
  ...
  describe 'grouped by' do
    context 'when is year' do
      it 'should return results grouped by year' do
        data = ManagedReports::Indicators::TotalReferralsByUserGroups.build(
          nil,
          {
