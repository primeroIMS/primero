...
describe ManagedReports::Indicators::SurvivorsNumberOfServicesProvidedOther do
  before do
  ...
  describe 'records in scope' do
    ...
    it 'returns group records for a group scope' do
      data = ManagedReports::Indicators::SurvivorsNumberOfServicesProvidedOther.build(@group_user).data
    ...
    it 'returns agency records for an agency scope' do
      data = ManagedReports::Indicators::SurvivorsNumberOfServicesProvidedOther.build(@agency_user).data
    ...
    it 'returns all records for an all scope' do
      data = ManagedReports::Indicators::SurvivorsNumberOfServicesProvidedOther.build(@all_user).data
  ...
  describe 'grouped by' do
    context 'when is year' do
      it 'should return results grouped by year' do
        data = ManagedReports::Indicators::SurvivorsNumberOfServicesProvidedOther.build(
          nil,
          {
