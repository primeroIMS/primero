  ...
  describe 'grouped by' do
    ...
    context 'when is month' do
      it 'should return results grouped by month' do
        ...
        expect(data).to match_array(
          [
            { group_id: 'august-2020', data: [{ id: 'denial_humanitarian_access', total: 1 }] },
            { group_id: 'august-2021', data: [{ id: 'denial_humanitarian_access', total: 2 }] },
            { group_id: 'january-2022', data: [{ id: 'denial_humanitarian_access', total: 1 }] },
            { group_id: 'february-2022', data: [{ id: 'denial_humanitarian_access', total: 1 }] }
          ]
        )
      end
    end
    ...
    context 'when is quarter' do
      it 'should return results grouped by quarter' do
        ...
        expect(data).to match_array(
          [
            { group_id: 'q1-2022', data: [{ id: 'denial_humanitarian_access', total: 2 }] },
            { group_id: 'q3-2020', data: [{ id: 'denial_humanitarian_access', total: 1 }] },
            { group_id: 'q3-2021', data: [{ id: 'denial_humanitarian_access', total: 2 }] }
          ]
        )
      end
    end
