...
describe ManagedReports::Indicators::IncidentViolenceTypeBySexAndAge do
  ...
  it 'returns data for incident_violence_type_by_sex_and_age indicator' do
    report_data = ManagedReports::Indicators::IncidentViolenceTypeBySexAndAge.build(nil, {}).data
  ...
  describe 'records in scope' do
    it 'returns records for a self scope' do
      report_data = ManagedReports::Indicators::IncidentViolenceTypeBySexAndAge.build(
        @self_user,
        {
    ...
    it 'returns all records for an all scope' do
      report_data = ManagedReports::Indicators::IncidentViolenceTypeBySexAndAge.build(@all_user, {}).data
  ...
  describe 'grouped by' do
    context 'when is year' do
      it 'should return results grouped by year' do
        data = ManagedReports::Indicators::IncidentViolenceTypeBySexAndAge.build(
          nil,
          {
