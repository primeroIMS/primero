...
describe ManagedReports::Indicators::ElapsedReportingTimeRape do
  ...
  describe 'records in scope' do
    it 'returns owned records for a self scope' do
      data = ManagedReports::Indicators::ElapsedReportingTimeRape.build(@self_user).data
    ...
    it 'returns group records for a group scope' do
      data = ManagedReports::Indicators::ElapsedReportingTimeRape.build(@group_user).data
    ...
    it 'returns agency records for an agency scope' do
      data = ManagedReports::Indicators::ElapsedReportingTimeRape.build(@agency_user).data
    ...
    it 'returns all records for an all scope' do
      data = ManagedReports::Indicators::ElapsedReportingTimeRape.build(@all_user).data
  ...
  describe 'grouped by' do
    context 'when is year' do
      it 'should return results grouped by year' do
        data = ManagedReports::Indicators::ElapsedReportingTimeRape.build(
          nil,
          {
