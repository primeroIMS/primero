_primero.Views.VisibleMobileField = Backbone.View.extend({
    ...
    events: {
        ...
        'change input.visible_on_mobile' : 'form_visible_change_mobile'

    },


    initialize: function() {
        var checkbox = $('#field_details .visible');
    ...
    set_visible_for_mobile_status: function (el) {
        var checkbox_control = el.parents('div').find('#field_details .mobile_visible');
        this.change_checkbox_status(el, checkbox_control);
        var checkbox = $('#field_details .visible_on_mobile');
        this.set_visible_for_minify_form(checkbox);
    },
