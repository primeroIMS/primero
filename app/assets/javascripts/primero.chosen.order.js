...
(function() {
  ...
  AbstractChosenOrder = (function() {
    ...
    option_selection = function(select) {
      ...
      for (var e = 0; e < grps.length; e++) {
        options.push(grps[e]);

        for (var g = 0; g < grps[e].getElementsByTagName('option').length; g++) {
          options.push(grps[e].getElementsByTagName('option')[g]);
        }
      }
      return options;
    };
  ...
  $.fn.extend({
    ...
    setSelectionOrder: function(order, force, optgroup) {
      return ChosenOrder.setSelectionOrder(this, order, force, optgroup);
    }
  });
