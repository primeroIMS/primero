...
class Header < ValueObject
  ...
  class << self
    ...
    def case_headers(user)
      ...
      header_list << CASE_NAME if !user.gbv_or_mrm_user? && user.can_list_case_names?
      ...
      header_list << AGE unless user.gbv_or_mrm_user?
      header_list << SEX unless user.gbv_or_mrm_user?
      header_list << REGISTRATION_DATE unless user.gbv_or_mrm_user?
      header_list << CASE_OPENING_DATE if user.module?(PrimeroModule::GBV)
      header_list << PHOTO if !user.gbv_or_mrm_user? && user.can?(:view_photo, Child)
    ...
    def incident_headers(user)
      ...
      header_list << CP_DATE_OF_INCIDENT unless user.gbv_or_mrm_user?
      header_list << CP_VIOLENCE_TYPE unless user.gbv_or_mrm_user?
