class Header < ValueObject
  ...
  CASE_NAME = Header.new(name: 'sort', field_name: 'sortable_name')
  SURVIVOR_CODE = Header.new(name: 'survivor_code', field_name: 'survivor_code_no')
  AGE= Header.new(name: 'age', field_name: 'age')
  SEX = Header.new(name: 'sex', field_name: 'sex')
  ...
  OWNED_BY = Header.new(name: 'owned_by', field_name: 'owned_by' )
  OWNED_BY_AGENCY = Header.new(name: 'owned_by_agency', field_name: 'owned_by_agency' )
