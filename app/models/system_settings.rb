class SystemSettings < CouchRest::Model::Base
  ...
  property :age_ranges, Hash, :default => { "primero" => AgeRangeGroup.createDefaultSet, "unhcr" => AgeRangeGroup.createUnhcrSet }
  property :primary_age_range, String, :default => "primero"
