  ...
  def self.resource_actions(resource)
     case resource
       ...
       when TRACING_REQUEST
         actions.reject {|a| [EXPORT_MRM_VIOLATION_XLS, EXPORT_INCIDENT_RECORDER, EXPORT_CASE_PDF, TRANSFER, REFERRAL, CONSENT_OVERRIDE, SYNC_MOBILE, REQUEST_APPROVAL, APPROVE_CASE_PLAN, COPY, GROUP_READ].include? a}
       when ROLE
