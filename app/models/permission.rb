class Permission
  ...
  def self.actions
    [
      ...
      VIEW_APPROVALS,
      VIEW_ASSESSMENT,
      VIEW_PROTECTION_CONCERN_FILTER,
  ...
  def self.resource_actions(resource)
     case resource
       ...
       when SYSTEM
         [MANAGE]
       when DASHBOARD
         [VIEW_APPROVALS, VIEW_ASSESSMENT, DASH_REPORTING_LOCATION, DASH_PROTECTION_CONCERNS, DASH_MATCHING_RESULTS, MANAGE, DASH_SERVICE_PROVISIONS, DASH_CASES_TO_ASSIGN, DASH_CASE_BY_WORKFLOW, DASH_MANAGER_TRANSERS, DASH_CASES_BY_SOCIAL_WORKER, DASH_REFFERALS_BY_SOCIAL_WORKER, DASH_TRANSERS_BY_SOCIAL_WORKER, VIEW_PROTECTION_CONCERNS_FILTER]
       else
         actions
     end
  end
