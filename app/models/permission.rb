     ...
     case resource
       when CASE
         [READ, CREATE, WRITE, ENABLE_DISABLE_RECORD, FLAG, INCIDENT_FROM_CASE, INCIDENT_DETAILS_FROM_CASE,
          ...
          TRANSFER, REFERRAL, CONSENT_OVERRIDE, SYNC_MOBILE, REQUEST_APPROVAL_BIA, REQUEST_APPROVAL_CASE_PLAN,
          ...
          FIND_TRACING_MATCH, ASSIGN_WITHIN_AGENCY, ASSIGN_WITHIN_USER_GROUP]
       when INCIDENT
         [READ, CREATE, WRITE,  ENABLE_DISABLE_RECORD, FLAG, EXPORT_LIST_VIEW, EXPORT_CSV, EXPORT_EXCEL, EXPORT_PHOTO_WALL, EXPORT_PDF,
