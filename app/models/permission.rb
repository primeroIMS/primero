class Permission
  ...
  EXPORT_DUPLICATE_MOHA = 'export_duplicate_moha_id_csv'
     ...
     case resource
       when CASE
         [READ, CREATE, WRITE, ENABLE_DISABLE_RECORD, FLAG, INCIDENT_FROM_CASE, INCIDENT_DETAILS_FROM_CASE,
          ...
          EXPORT_PHOTO_WALL, EXPORT_PDF, EXPORT_UNHCR, EXPORT_CASE_PDF, EXPORT_JSON, EXPORT_CUSTOM, IMPORT, ASSIGN,
          ...
          DISPLAY_VIEW_PAGE, REQUEST_TRANSFER, VIEW_PHOTO, REFERRAL_FROM_SERVICE, REMOVE_ASSIGNED_USERS, ADD_NOTE, EXPORT_DUPLICATE_MOHA]
       when INCIDENT
         [READ, CREATE, WRITE, FLAG, EXPORT_LIST_VIEW, EXPORT_CSV, EXPORT_EXCEL, EXPORT_PHOTO_WALL, EXPORT_PDF,
          EXPORT_UNHCR, EXPORT_MRM_VIOLATION_XLS, EXPORT_INCIDENT_RECORDER, EXPORT_JSON, EXPORT_CUSTOM, IMPORT, ASSIGN,
