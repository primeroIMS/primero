...
class Permission < ValueObject
  ...
  RESOURCE_ACTIONS = {
    ...
    MANAGED_REPORT => [
      ...
      PROCESS_QUALITY_TOTAL_CASES, PROCESS_QUALITY_AVERAGE_CASES, CASES_WORKFLOW_REPORT, VIOLENCE_TYPE_REPORT,
      REFERRALS_TRANSFERS_REPORT, PROTECTION_CONCERNS_REPORT, FOLLOWUPS_REPORT, SERVICES_REPORT,
