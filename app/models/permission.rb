...
class Permission < ValueObject
  ...
  RESOURCE_ACTIONS = {
    CASE => [
      ...
      RECEIVE_TRANSFER, REFERRAL, RECEIVE_REFERRAL, REOPEN, CLOSE, VIEW_PROTECTION_CONCERNS_FILTER, CHANGE_LOG, MANAGE
    ],
    INCIDENT => [
  ...
  class << self
    ...
    def actions
      [READ, CREATE, WRITE, ENABLE_DISABLE_RECORD, FLAG, INCIDENT_FROM_CASE, INCIDENT_DETAILS_FROM_CASE,
       ...
       DASH_SHARED_WITH_MY_TEAM, DASH_CASE_INCIDENT_OVERVIEW]
    end
