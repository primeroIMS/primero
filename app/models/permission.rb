...
class Permission < ValueObject
  ...
  CREATE_CASE_RELATIONSHIPS = 'create_case_relationships'
  REMOVE_CASE_RELATIONSHIPS = 'remove_case_relationships'
  ...
  RESOURCE_ACTIONS = {
    CASE => [
      ...
      SERVICE_OWN_ENTRIES_ONLY, CREATE_CASE_FROM_REFERRAL, CREATE_CASE_RELATIONSHIPS, MANAGE, REMOVE_CASE_RELATIONSHIPS
    ],
    INCIDENT => [
