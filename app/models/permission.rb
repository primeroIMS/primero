  ...
  def self.resource_actions(resource)
    ...
    when CASE
      [READ, CREATE, WRITE, ENABLE_DISABLE_RECORD, FLAG, INCIDENT_FROM_CASE, INCIDENT_DETAILS_FROM_CASE,
       ...
       EXPORT_PHOTO_WALL, EXPORT_UNHCR, EXPORT_CASE_PDF, EXPORT_DUPLICATE_ID, EXPORT_JSON, EXPORT_CUSTOM, IMPORT,
    ...
    when INCIDENT
      [READ, CREATE, WRITE, FLAG, EXPORT_LIST_VIEW, EXPORT_CSV, EXPORT_EXCEL, EXPORT_PHOTO_WALL, EXPORT_CASE_PDF,
