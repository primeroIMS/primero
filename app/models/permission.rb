...
class Permission < ValueObject
  ...
  RESOURCE_ACTIONS = {
    CASE => [
      ...
      SERVICE_OWN_ENTRIES_ONLY, CREATE_CASE_FROM_REFERRAL, MANAGE
    ],
    INCIDENT => [
    ...
    MANAGED_REPORT => [
      ...
      PROCESS_QUALITY_IMPLEMENTED_REFERRALS, CASES_WORKFLOW_REPORT, VIOLENCE_TYPE_REPORT, REFERRALS_TRANSFERS_REPORT,
      PROTECTION_CONCERNS_REPORT, FOLLOWUPS_REPORT, SERVICES_REPORT, REPORTING_LOCATIONS_REPORT
    ],
    METADATA => [MANAGE],
