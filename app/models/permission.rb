class Permission
  ...
  EXPORT_CHILD_PDF = 'export_child_pdf'
     ...
     case resource
       when CASE
         [READ, CREATE, WRITE, ENABLE_DISABLE_RECORD, FLAG, INCIDENT_FROM_CASE, INCIDENT_DETAILS_FROM_CASE,
          ...
          EXPORT_PHOTO_WALL, EXPORT_PDF, EXPORT_UNHCR, EXPORT_CASE_PDF, EXPORT_CHILD_PDF, EXPORT_DUPLICATE_ID, EXPORT_JSON, EXPORT_CUSTOM, IMPORT,
          ...
          REFERRAL, RECEIVE_REFERRAL, VIEW_PROTECTION_CONCERNS_FILTER]
       when INCIDENT
       ...
       when DASHBOARD
         [VIEW_APPROVALS, VIEW_RESPONSE, VIEW_ASSESSMENT, DASH_REPORTING_LOCATION, DASH_PROTECTION_CONCERNS,
          ...
          DASH_SHOW_NONE_VALUES, DASH_TASKS, DASH_NATIONAL_ADMIN_SUMMARY]
       when AUDIT_LOG
         [READ]
