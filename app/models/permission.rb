...
class Permission < ValueObject
  ...
  RESOURCE_ACTIONS = {
    CASE => [
      ...
      TRANSFER, RECEIVE_TRANSFER, ACCEPT_OR_REJECT_TRANSFER, REFERRAL, RECEIVE_REFERRAL, ACCESS_LOG,
      RECEIVE_REFERRAL_DIFFERENT_MODULE, REOPEN, CLOSE, VIEW_PROTECTION_CONCERNS_FILTER, CHANGE_LOG, LIST_CASE_NAMES,
      VIEW_REGISTRY_RECORD, ADD_REGISTRY_RECORD, VIEW_FAMILY_RECORD, CASE_FROM_FAMILY, LINK_FAMILY_RECORD, REMOVE_ALERT,
      SERVICE_OWN_ENTRIES_ONLY, CREATE_CASE_FROM_REFERRAL, UPDATE_CASE_RELATIONSHIPS, VIEW_CASE_RELATIONSHIPS, MANAGE
    ],
    INCIDENT => [
