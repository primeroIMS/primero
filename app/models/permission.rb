...
class Permission < ValueObject
  ...
  class << self
    ...
    def resources
      [CASE, INCIDENT, TRACING_REQUEST, POTENTIAL_MATCH, ROLE, USER, USER_GROUP, AGENCY, WEBHOOK, METADATA, SYSTEM,
       REPORT, MANAGED_REPORT, DASHBOARD, AUDIT_LOG, MATCHING_CONFIGURATION, DUPLICATE, CODE_OF_CONDUCT, ACTIVITY_LOG]
    end
