...
class Permission < ValueObject
  ...
  ACCEPT_OR_REJECT_REFERRAL = 'accept_or_reject_referral'
  REOPEN = 'reopen'
  CLOSE = 'close'
  DELETE = 'delete'
  ...
  PROCESS_QUALITY_TOTAL_CASES = 'process_quality_total_cases'
  PROCESS_QUALITY_AVERAGE_CASES = 'process_quality_average_cases'
  PROCESS_QUALITY_SUCCESSFUL_REFERRALS = 'process_quality_successful_referrals'
  PROCESS_QUALITY_IMPLEMENTED_REFERRALS = 'process_quality_implemented_referrals'
  ...
  CASE_MANAGEMENT_KPIS_SERVICE_REFERRALS_REPORT = 'case_management_kpis_service_referrals_report'
  ...
  RESOURCE_ACTIONS = {
    CASE => [
      READ, CREATE, WRITE, ENABLE_DISABLE_RECORD, FLAG, BULK_FLAG, FLAG_RESOLVE_ANY, FLAG_UPDATE, ATTRIBUTE,
      INCIDENT_FROM_CASE, INCIDENT_DETAILS_FROM_CASE, VIEW_INCIDENT_FROM_CASE,
      ...
      REQUEST_APPROVAL_CLOSURE, REQUEST_APPROVAL_ACTION_PLAN, REQUEST_APPROVAL_GBV_CLOSURE, APPROVE_ASSESSMENT,
      APPROVE_CASE_PLAN, APPROVE_CLOSURE, APPROVE_ACTION_PLAN, APPROVE_GBV_CLOSURE, SELF_APPROVE,
      SEARCH_OWNED_BY_OTHERS, DISPLAY_VIEW_PAGE, REQUEST_TRANSFER, VIEW_PHOTO, REFERRAL_FROM_SERVICE, ADD_NOTE,
      FIND_TRACING_MATCH, ASSIGN, ASSIGN_WITHIN_AGENCY, ASSIGN_WITHIN_USER_GROUP, REMOVE_ASSIGNED_USERS,
      TRANSFER, RECEIVE_TRANSFER, ACCEPT_OR_REJECT_TRANSFER, REFERRAL, RECEIVE_REFERRAL, ACCEPT_OR_REJECT_REFERRAL,
      ACCESS_LOG, RECEIVE_REFERRAL_DIFFERENT_MODULE, REOPEN, CLOSE, VIEW_PROTECTION_CONCERNS_FILTER, CHANGE_LOG,
      LIST_CASE_NAMES, VIEW_REGISTRY_RECORD, ADD_REGISTRY_RECORD, VIEW_FAMILY_RECORD, CASE_FROM_FAMILY,
      LINK_FAMILY_RECORD, REMOVE_ALERT, SERVICE_OWN_ENTRIES_ONLY, CREATE_CASE_FROM_REFERRAL, UPDATE_CASE_RELATIONSHIPS,
      VIEW_CASE_RELATIONSHIPS, MANAGE
    ],
    INCIDENT => [
      READ, CREATE, WRITE, ENABLE_DISABLE_RECORD, FLAG, FLAG_RESOLVE_ANY, FLAG_UPDATE, EXPORT_LIST_VIEW, EXPORT_CSV,
      EXPORT_EXCEL, EXPORT_PDF, EXPORT_INCIDENT_RECORDER, EXPORT_JSON, EXPORT_CUSTOM, IMPORT, SYNC_MOBILE, CHANGE_LOG,
      ACCESS_LOG, EXPORT_MRM_VIOLATION_XLS, REMOVE_ALERT, VERIFY_MRM, ASSIGN, LINK_INCIDENT_TO_CASE, MANAGE
    ],
    TRACING_REQUEST => [
      READ, CREATE, WRITE, ENABLE_DISABLE_RECORD, FLAG, FLAG_RESOLVE_ANY, FLAG_UPDATE, EXPORT_LIST_VIEW, EXPORT_CSV,
      EXPORT_EXCEL, EXPORT_PDF, EXPORT_JSON, EXPORT_CUSTOM, IMPORT, CHANGE_LOG, ACCESS_LOG, MANAGE
    ],
    REGISTRY_RECORD => [
      READ, CREATE, WRITE, ENABLE_DISABLE_RECORD, FLAG, FLAG_RESOLVE_ANY, FLAG_UPDATE, EXPORT_CSV, EXPORT_EXCEL,
      EXPORT_JSON, CHANGE_LOG, ACCESS_LOG, SYNC_MOBILE, MANAGE
    ],
    FAMILY => [
    ...
    USER => [CREATE, READ, AGENCY_READ, WRITE, DISABLE_MULTIPLE, SEND_EMAIL_MULTIPLE, MANAGE],
    ...
    MANAGED_REPORT => [
      VIOLATION_REPORT, GBV_STATISTICS_REPORT, GHN_REPORT, INDIVIDUAL_CHILDREN, WORKFLOW_REPORT, PROTECTION_OUTCOMES,
      PROCESS_QUALITY_TOTAL_CASES, PROCESS_QUALITY_AVERAGE_CASES, PROCESS_QUALITY_SUCCESSFUL_REFERRALS,
      PROCESS_QUALITY_IMPLEMENTED_REFERRALS, CASE_CHARACTERISTICS, CASES_WORKFLOW_REPORT,
      VIOLENCE_TYPE_REPORT, REFERRALS_TRANSFERS_REPORT, PROTECTION_CONCERNS_REPORT, FOLLOWUPS_REPORT, SERVICES_REPORT,
    ...
    DASHBOARD => [
      ...
      DASH_ACTION_NEEDED_NEW_REFERRALS, DASH_ACTION_NEEDED_TRANSFER_AWAITING_ACCEPTANCE, DASH_ACTION_NEEDED_IDENTIFIED
    ],
    AUDIT_LOG => [READ],
    USAGE_REPORT => [READ],
  ...
  class << self
    ...
    def resources
      [CASE, INCIDENT, TRACING_REQUEST, FAMILY, POTENTIAL_MATCH, REGISTRY_RECORD, ROLE, USER, USER_GROUP, AGENCY,
       WEBHOOK, METADATA, SYSTEM, REPORT, MANAGED_REPORT, DASHBOARD, AUDIT_LOG, USAGE_REPORT, MATCHING_CONFIGURATION,
       DUPLICATE, CODE_OF_CONDUCT, ACTIVITY_LOG]
    end
  ...
  def record_with_ownership_authorization?
    [CASE, INCIDENT, TRACING_REQUEST, FAMILY].include?(resource)
  end
