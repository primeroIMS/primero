class Permission
  ...
  def self.resource_actions(resource)
     case resource
       when CASE
         [READ, CREATE, WRITE, FLAG, INCIDENT_FROM_CASE, INCIDENT_DETAILS_FROM_CASE, EXPORT_LIST_VIEW, EXPORT_CSV, EXPORT_EXCEL, EXPORT_PHOTO_WALL, EXPORT_PDF, EXPORT_UNHCR, EXPORT_CASE_PDF, EXPORT_JSON, EXPORT_CUSTOM, IMPORT, ASSIGN, TRANSFER, REASSIGN, REFERRAL, CONSENT_OVERRIDE, SYNC_MOBILE, REQUEST_APPROVAL_BIA, REQUEST_APPROVAL_CASE_PLAN, REQUEST_APPROVAL_CLOSURE, APPROVE_BIA, APPROVE_CASE_PLAN, APPROVE_CLOSURE, MANAGE, SEARCH_OWNED_BY_OTHERS]
       when INCIDENT
