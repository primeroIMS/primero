...
class SearchFilters::TransitionUsersPresent < SearchFilters::Value
      ...
      [
        %(
          EXISTS (
            ...
            AND (
              (transitions.transitioned_to IS NOT NULL AND TRUE = :value)
                OR (transitions.transitioned_to IS NULL AND FALSE = :value)
            )
