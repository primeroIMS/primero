...
class Child < CouchRest::Model::Base
  ...
  def self.quicksearch_fields
    ...
    # The fields oscar_short_id, oscar_number and mosvy_number are hacked in only because of Cambodia
    ...
    [
      ...
      'oscar_number', 'mosvy_number', 'oscar_short_id'
    ]
  end
  ...
  searchable auto_index: self.auto_index? do
    ...
    time :transitions_changed_at, as: 'transitions_changed_at_d' do
      self.transitions_changed_at if self.transitions_changed_at.present?
    end
