...
class ManagedReports::Indicators::IncidentWorkflowByAge < ManagedReports::SqlReportIndicator
  include ManagedReports::TsfvIndicatorHelper

  class << self
    def id
      'incident_workflow_by_age'
    end
    ...
    def sql(current_user, params = {})
      ...
      %{
          with incident_workflow_by_age as (
            select
