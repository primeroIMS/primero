...
class ManagedReports::Indicators::CaseWorkflowByAge < ManagedReports::SqlReportIndicator
  include ManagedReports::TsfvIndicatorHelper

  class << self
    def id
      'case_workflow_by_age'
    end
