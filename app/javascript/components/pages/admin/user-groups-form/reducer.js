...
export default (state = DEFAULT_STATE, { type, payload }) => {
  switch (type) {
    ...
    case actions.FETCH_USER_GROUP_SUCCESS:
      return state.set("selectedUserGroup", fromJS(payload.data)).set("errors", false).set("serverErrors", fromJS([]));
    ...
    case actions.CLEAR_SELECTED_USER_GROUP:
      return state.set("selectedUserGroup", fromJS({})).set("errors", false).set("serverErrors", fromJS([]));
