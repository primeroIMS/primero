...
export default (state = DEFAULT_STATE, { type, payload }) => {
  switch (type) {
    case actions.FETCH_ROLE_STARTED:
      return state.set("loading", true).set("errors", false).set("serverErrors", fromJS([]));
    case actions.FETCH_ROLE_SUCCESS:
      return state.set("selectedRole", fromJS(payload.data)).set("errors", false).set("serverErrors", fromJS([]));
