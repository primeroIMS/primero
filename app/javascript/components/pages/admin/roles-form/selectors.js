...
export const getRole = state => state.getIn(["records", "admin", NAMESPACE, "selectedRole"], fromJS({}));

export const getServerErrors = state => state.getIn(["records", "admin", NAMESPACE, "serverErrors"], fromJS([]));
