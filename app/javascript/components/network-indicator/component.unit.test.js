...
describe("<NetworkIndicator />", () => {
  it("should render an online indicator when the application is online", () => {
    const { component } = setupMountedComponent(NetworkIndicator, {}, fromJS({ application: { online: true } }));
  ...
  it("should render an offline indicator when the application is offline", () => {
    const { component } = setupMountedComponent(NetworkIndicator, {}, fromJS({ application: { online: false } }));
