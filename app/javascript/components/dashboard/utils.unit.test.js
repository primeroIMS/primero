  ...
  describe("toData1D", () => {
    describe("when isManager is false", () => {
      it("should convert data to string", () => {
        ...
        const queryValues = ["owned_by=primero", "record_state=true", "status=open", "workflow=care_plan"];
    ...
    describe("when a filter has multiple values", () => {
      it("should convert data to string", () => {
        ...
        const queryValues = ["record_state=true", "status=open,closed", "workflow=closed"];
