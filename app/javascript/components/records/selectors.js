...
export const getCaseFromFamilyMember = state => state.getIn(["records", "families", "case", "data"], fromJS({}));

export const getCaseFormFamilyMemberLoading = state => state.getIn(["records", "families", "case", "loading"], false);
