...
describe("<Transitions /> - Actions", () => {
  it("should have known actions", () => {
    ...
    expect(cloneActions).to.have.property("REFERRAL_USERS_FETCH");
    expect(cloneActions).to.have.property("REFERRAL_USERS_FETCH_SUCCESS");
    expect(cloneActions).to.have.property("REFERRAL_USER");
    expect(cloneActions).to.have.property("REFERRAL_USER_SUCCESS");
    expect(cloneActions).to.have.property("REFERRAL_USER_STARTED");
    expect(cloneActions).to.have.property("REFERRAL_USER_FAILURE");
    expect(cloneActions).to.have.property("REFER_USER");
    expect(cloneActions).to.have.property("REFER_USER_SUCCESS");
    expect(cloneActions).to.have.property("REFER_USER_STARTED");
    expect(cloneActions).to.have.property("REFER_USER_FAILURE");
    ...
    delete cloneActions.REFERRAL_USERS_FETCH;
    delete cloneActions.REFERRAL_USERS_FETCH_SUCCESS;
    delete cloneActions.REFERRAL_USER;
    delete cloneActions.REFERRAL_USER_SUCCESS;
    delete cloneActions.REFERRAL_USER_STARTED;
    delete cloneActions.REFERRAL_USER_FAILURE;
    delete cloneActions.REFER_USER;
    delete cloneActions.REFER_USER_SUCCESS;
    delete cloneActions.REFER_USER_STARTED;
    delete cloneActions.REFER_USER_FAILURE;
