...
describe("<RecordForm>/form/subforms/<SubformTraces>/components/<TraceComparisonForm>", () => {
    ...
    it("should render the top fields", () => {
        mountedComponent(<TraceComparisonForm {...initialProps} />, initialState, ["tr/trq-9876-5432"],
            {}, {}, "tr/:id");
    ...
    it("should render not found for forms without comparison data", () => {
        mountedComponent(<TraceComparisonForm {...initialProps} />, initialState, ["tr/trq-9876-5432"],
            {}, {}, "tr/:id");
        expect(screen.getAllByText(/tracing_request.messages.nothing_found/i)).toHaveLength(4);
    });
