...
import { buildOptions, getSelectFieldDefaultValue, handleChangeOnServiceUser, apiSelectOffline } from "../utils";
...
const SelectFieldContainer = ({
  ...
  const apiSelectOptionsOffline = apiSelectOffline(online, option);
