...
export const ENABLE_DISABLE_RECORD = [
...
export const FLAG_RECORDS = [
  PERMISSION_CONSTANTS.FLAG,
  PERMISSION_CONSTANTS.MANAGE
];

export const WRITE_RECORDS = [
  PERMISSION_CONSTANTS.WRITE,
  PERMISSION_CONSTANTS.MANAGE
];

export const DISPLAY_VIEW_PAGE = [
