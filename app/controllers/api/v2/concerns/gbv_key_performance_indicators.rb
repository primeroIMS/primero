...
module Api::V2::Concerns
  ...
  module GBVKeyPerformanceIndicators
    ...
    module Searches
      ...
      # of months.
      class NumberOfCases < KPI::PivotedRangeSearch
        search_model Child
      ...
      # a range of months.
      class NumberOfIncidents < KPI::PivotedRangeSearch
      ...
      class ReportingDelay < KPI::BucketedSearch
        search_model Incident
      ...
      class TimeFromCaseOpenToClose < KPI::BucketedSearch
        search_model Child
      ...
      class CaseClosureRate < KPI::PivotedRangeSearch
        search_model Child
        pivot_field :owned_by_location
