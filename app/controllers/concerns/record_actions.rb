module RecordActions
  ...
  def select_permitted_fields(record, permitted_property_names, is_remote_request)
    ...
    default_fields_to_share = is_remote_request ? %w[module_id] : %w[_id _rev couchrest-type histories photo_keys document_keys case_id short_id owned_by created_by registration_date incident_id tracing_request_id inquiry_date incident_links alerts]
