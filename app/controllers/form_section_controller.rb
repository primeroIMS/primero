    ...
    if parent_form_param == 'case'
      for section in form_sections["Children"]
        ...
        for field in section["fields"]
          field.slice!("name", "editable", "multi_select", "type", "subform", "required", "show_on_short_form","mobile_visible", :display_name, :help_text, :option_strings_text)
          if field["type"] == "subform"
            ...
            for subfield in field["subform"]["fields"]
              subfield.slice!("name", "editable", "multi_select", "type", "required", "show_on_short_form","mobile_visible", :display_name, :help_text, :option_strings_text)
            end
          end
        end
      end
