module WeeklyReport
  ...
  def self.data
    ...
    protection_statuses = fields.find{|field| field[:name] == "protection_status"}.option_strings_text.map{|o| o['display_text']}
    genders = fields.find{|field| field[:name] == "gender"}.option_strings_text.map{|o| o['display_text']}
    ftr_statuses = fields.find{|field| field[:name] == "ftr_status"}.option_strings_text.map{|o| o['display_text']}
