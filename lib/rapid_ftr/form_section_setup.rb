  ...
  module FormSectionSetup
    ...
    def self.reset_definitions
      ...
      caafag_profile_fields = [
        ...
        Field.new({"name" => "name_armed_group",
                   "type" => "select_box",
        ...
        Field.new({"name" => "enrollment_reason_not_forced",
                   "type" => "select_box",
        ...
        Field.new({"name" => "enrollment_reason_not_forced_text",
                   "type" => "text_field",
                   "display_name_all" => "Other reason for enrollment"
                  }),
        Field.new({"name" => "name_militaryunit",
                   "type" => "text_field",
                   "display_name_all" => "Name of Military Unit"
                  }),
        Field.new({"name" => "name_commander",
                   "type" => "text_field",
                   "display_name_all" => "Commander's Name"
                  }),
        Field.new({"name" => "address_militaryunit",
                   "type" => "text_field",
                   "display_name_all" => "Area of Military Unit"
                  }),
        Field.new({"name" => "location_militaryunit",
                   "type" => "text_field",
        ...
        Field.new({"name" => "date_child_join",
                   "type" => "date_field",
        ...
        Field.new({"name" => "address_Mobilization",
                   "type" => "text_field",
                   "display_name_all" => "Area of Mobilization"
                  }),
        Field.new({"name" => "location_mobilization",
                   "type" => "text_field",
      ...
      FormSection.create_or_update_form_section({"visible"=>true,
                          :order=> 12, :unique_id=>"caafag_profile", :fields => caafag_profile_fields,
