...
Feature: GBV Survivor Assessment Form
  ...
  Scenario: As a logged in user, I create a new case
    ...
    And I fill in the following:
      ...
      | Assessment of Presenting Problem                               | Assessment of presenting problem                                    |
      | Assessment of Immediate Need                                   | Assessment of immediate need                                        |
    ...
    And I should see a value for "Assessment of Presenting Problem" on the show page with the value of "Assessment of presenting problem"
    And I should see a value for "Assessment of Immediate Need" on the show page with the value of "Assessment of immediate need"
