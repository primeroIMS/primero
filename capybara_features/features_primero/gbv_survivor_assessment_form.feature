...
Feature: GBV Survivor Assessment Form
  ...
  Scenario: As a logged in user, I create a new case
    ...
    And I fill in the following:
      ...
      | Describe the survivor’s emotional state                        | <Select> Things are so bad that they want to die or hurt themselves |
    And I press "Save"
    ...
    And I should see a value for "Describe the survivor’s emotional state" on the show page with the value of "Things are so bad that they want to die or hurt themselves"