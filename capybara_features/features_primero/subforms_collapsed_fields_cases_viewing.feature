...
Feature: Subforms Collapses Fields Cases Viewing
  ...
  Scenario: As a logged in user, I want to verify collapsed fields for tracing in viewing
    ...
    And I should see expanded the 2nd "Tracing Actions Section" subform
    And I should see header in the 1st "Tracing Actions Section" subform within "Photo Tracing - 30-May-2014"
    And I should see header in the 2nd "Tracing Actions Section" subform within "Individual Tracing - 30-Jun-2014"
    And I should see collapsed the 1st "Reunification Details Section" subform
    And I should see expanded the 2nd "Reunification Details Section" subform
  ...
  Scenario: As a logged in user, I want to verify collapsed fields for followup in viewing
    ...
    And I should see header in the 1st "Followup Subform Section" subform within "Health/Medical Service - Medical Intervention Assessment - 12-Jun-2014"
  ...
  Scenario: As a logged in user, I want to verify collapsed fields for family details in viewing
    ...
    And I should see header in the 1st "Family Details Section" subform within "Mother - Socorro"
    And I should see header in the 2nd "Family Details Section" subform within "Father - Pedro"

  Scenario: As a logged in user, I want to verify collapsed fields for services in viewing
    And I press the "Services / Follow Up" button
    ...
    And I should see header in the 1st "Services Section" subform within "Safehouse - 30-May-2014"
    And I should see header in the 2nd "Services Section" subform within "Health/Medical - 30-Jun-2014"

  Scenario: As a logged in user, I want to verify collapsed fields for child's wishes in viewing
    And I press the "Tracing" button
    ...
    And I should see header in the 1st "Child Preferences Section" subform within "Second choice - Juan"
    And I should see header in the 2nd "Child Preferences Section" subform within "First choice - María"

  Scenario: As a logged in user, I want to verify collapsed fields for verification in viewing
    And I press the "Tracing" button
    ...
    And I should see header in the 1st "Verification Subform Section" subform within "Father - Mr. Smith"
    And I should see header in the 2nd "Verification Subform Section" subform within "Brother - John Snow"

  Scenario: As a logged in user, I want to verify collapsed fields for protection concern in viewing
    ...
    And I should see header in the 1st "Protection Concern Detail Subform Section" subform within "Migrant"
