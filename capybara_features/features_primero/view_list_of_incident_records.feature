...
Feature: Primero View List of Incident Records
  ...
  Scenario: I want to see my incidents
    ...
    And the following incidents exist in the system:
      ...
      | primero_mrm | 03-Feb-2004          | active   | 41c4cba8-b410-4af6-b349-68c557af3aa7 |
      | primero_mrm | 03-Feb-2004          | Inactive | 51c4cba8-b410-4af6-b349-68c557af3aa6 |
      | primero_mrm | 03-Feb-2004          | active   | 61c4cba8-b410-4af6-b349-68c557af3aa5 |
    ...
    And I should see "Incident ID #7af3aa9"
